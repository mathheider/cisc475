...
public class FindAnswers {
	...
	public final static char[] beginEnumerate = "\\begin{enumerate}"
			.toCharArray();

	public final static char[] item = "\\item".toCharArray();

	public final static char[] endEnumerate = "\\end{enumerate}".toCharArray();
	...
	/*
	 * For each problem i, start index of each answer to the problem (out). This
	 * is an array of length number of problems. answerStarts[i] is an array
	 * whose length is the number of answers to the i-th problem.
	 * answerStarts[i][j] is the index in chars of the first character of the
	 * j-th answer to the i-th problem.
	 */
	int[][] answerStarts;

	/*
	 * Like answerStarts, except it gives the stop index of each answer (out).
	 * That is 1 greater than the index of the last character of the answer.
	 */
	int[][] answerStops;

	/*
	 * Constructs new FindAnswers instance from the given data. Sets the fields
	...
	/*
	 * Tells you whether the sequence of chars starting at position in array
	 * chars matches those of c
	 */
	...
	/*
	 * Finds the answers to the problem with ID pid, setting answerStarts[pid]
	 * and answerStops[pid].
	 */
